  ...
  private _buildSearchForm(){
    return html`
      <div class='search-form'>
        ...
        <mwc-button outlined label="Search" icon="code"></mwc-button>
        <mwc-button outlined label="Recent" icon="code"></mwc-button>
        <mwc-button outlined label="Cancel" icon="code"></mwc-button>
      </div>
    `
  }
