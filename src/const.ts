...
export const DEFAULT_MEDIA_TYPE_ORDER       = MEDIA_TYPES
    .filter(type => MEDIA_TYPE_PARAMS[type].order >= 0)
    .sort((a, b) => MEDIA_TYPE_PARAMS[a].order - MEDIA_TYPE_PARAMS[b].order);
