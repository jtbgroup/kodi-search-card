...
class SearchSensorCard extends HTMLElement {
  ...
  fillSongs(items, resultDiv) {
    ...
    songsDiv.setAttribute('class', 'search-songs-grid search-grid search-item-container-grid');
    ...
    for (let count = 0; count < max; count++) {
      ...
      durationDiv.innerHTML = new Date(item['duration'] * 1000).toISOString().substring(11, 19);
  ...
  fillAlbums(items, resultDiv) {
    ...
    albumsDiv.setAttribute('class', 'search-albums-grid search-grid search-item-container-grid');
  ...
  fillArtists(items, resultDiv) {
    ...
    let mediaTypeDiv = document.createElement('div');
    mediaTypeDiv.setAttribute('class', 'media-type-div');
    mediaTypeDiv.innerHTML = 'Artists <ha-icon icon="mdi:account-circle"></ha-icon>';
    rowsDiv.appendChild(mediaTypeDiv);

    let artistsDiv = document.createElement('div');
    artistsDiv.setAttribute('class', 'search-artists-grid  search-grid search-item-container-grid');
  ...
  fillMovies(items, resultDiv) {
    ...
    moviesDiv.setAttribute('class', 'search-movies-grid  search-grid search-item-container-grid');
    ...
    for (let count = 0; count < max; count++) {
      ...
      let cover = item['poster'] && item['poster'] != '' ? item['poster'] : item['thumbnail'];
  ...
  fillEpisode(items, resultDiv) {
    ...
    episodesDiv.setAttribute('class', 'search-episodes-grid  search-grid search-item-container-grid');
  ...
  fillTvShows(items, resultDiv) {
    ...
    tvshowsDiv.setAttribute('class', 'search-tvshows-grid  search-grid search-item-container-grid');
  ...
  fillChannel(items, resultDiv, type) {
    ...
    mediaTypeDiv.setAttribute('class', 'media-type-div');
    mediaTypeDiv.innerHTML = labelTitle + ' <ha-icon icon="' + iconTitle + '"></ha-icon>';
    rowsDiv.appendChild(mediaTypeDiv);

    let channelsDiv = document.createElement('div');
    channelsDiv.setAttribute('class', 'search-channel-grid search-grid search-item-container-grid');
    ...
    for (let count = 0; count < max; count++) {
      ...
      channelTypeDiv.innerHTML = item['channeltype'] + ' ( nr ' + item['channelnumber'] + ')';
  ...
  fillAlbumDetails(items, resultDiv) {
    ...
    let albumsDiv = document.createElement('div');
    albumsDiv.setAttribute('class', 'search-albumsdetails-grid search-grid search-item-container-grid');
    ...
    for (let count = 0; count < max; count++) {
      ...
      albumDetailsDiv.setAttribute('class', 'search-albumdetails-grid  search-grid');
      ...
      albumTitleDiv.setAttribute('class', 'search-albumdetails-title search-title');
      ...
      for (let idx = 0; idx < songsItem.length; idx++) {
        ...
        playDiv.addEventListener('click', () => this.addSong(songsItem[idx]['songid']));

        let els = [titleDiv, trackDiv];
        playDiv.addEventListener('mouseover', () => this.highlightOver(els, true));
        playDiv.addEventListener('mouseout', () => this.highlightOver(els, false));
  ...
  fillTVShowSeasonDetails(items, resultDiv) {
    ...
    let mediaTypeDiv = document.createElement('div');
    mediaTypeDiv.setAttribute('class', 'media-type-div');
    mediaTypeDiv.innerHTML = 'Season Details <ha-icon icon="mdi:movie"></ha-icon>';
    ...
    for (let count = 0; count < max; count++) {
      ...
      seasonDiv.setAttribute('class', 'search-seasondetails-grid  search-grid search-item-container-grid');
      ...
      seasonTitleDiv.setAttribute('class', 'search-seasondetails-title search-title');
      ...
      for (let idx = 0; idx < episodesItem.length; idx++) {
        ...
        if (episodesItem[idx]['season'] && episodesItem[idx]['season']) {
          let track =
            episodesItem[idx]['season'] + 'x' + episodesItem[idx]['episode'].toString().padStart(2, '0') + '.';
        ...
        playDiv.setAttribute('icon', actionIcon);
        playDiv.setAttribute('class', 'search-albumdetails-song-play');
        playDiv.addEventListener('click', () => this.addEpisodes(episodesItem[idx]['episodeid']));
